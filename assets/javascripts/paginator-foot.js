            ...
            onPageChanged: function(e,oldPage,newPage){
                ...
                $.getJSON( url, function( data ) {
					...
					for(var b=0; b< data.licitaciones.length;b++){
                        ...
                        $('.search-result-item .collapsable-text').find("[namelinklic='"+b+"']").attr("href","/file?type=licitacion&code="+data.licitaciones[b].id);
            ...
            onPageChanged: function(e,oldPage,newPage){
                ...
                $.getJSON( url, function( data ) {
                    ...
                    for(var b=0; b< data.organismos.length;b++){
                        ...
                        $('.search-result-item .collapsable-text').find("[namelinkorg='"+b+"']").attr("href","/file?type=organismo&code="+data.organismos[b].id);
